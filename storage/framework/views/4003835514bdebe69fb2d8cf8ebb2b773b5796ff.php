            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="colorfondo ibox-content">
                        ...
                        <br>
                        <?php echo $__env->make('herramienta.modalcreate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                ...
                                <tbody>                                    
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" width="100px">
                                            <form action="<?php echo e(route('herramienta.destroy', $item->id)); ?>" method="POST">                           
                                    ...
                                    <?php echo $__env->make('herramienta.modaledit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>                                            
...
<?php echo $__env->make('layouts.normal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\datos\proylaravel\constructora\resources\views/herramienta/index.blade.php ENDPATH**/ ?>