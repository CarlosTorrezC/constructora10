 ...
 <!-- modal Envelope-->
 <form method="POST" action="<?php echo e(route('dotacion.store')); ?>" role="form" autocomplete="off">
    <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <!-- <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <input name="stock" id="stock" type="text" class="form-control" required></input>                          
                        </div>
                    </div>                                                                    -->
                </div>
                <!--footer-->
...
<!-- modal--><?php /**PATH C:\datos\proylaravel\constructora\resources\views/dotacion/modalcreate.blade.php ENDPATH**/ ?>