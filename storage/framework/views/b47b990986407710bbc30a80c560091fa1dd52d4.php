...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    *
    ...
    <ul class="optionsBar">
        <li class="menuItem">
            <a href="<?php echo e(route('inicio.index')); ?>" class="menuOption">
        ...
        <?php if(session()->get('sessionLoggedRol')=='2'): ?>
            <li class="menuItem">   
                <a href="<?php echo e(route('usuario.index')); ?>" class="menuOption">
                    <i class="fas fa-user"></i><h5 class="menuText"> Gest. Usuario</h5>
                </a> 
            </li>                              
            <li class="menuItem">            
                <a href="<?php echo e(route('reporte.index')); ?>" class="menuOption">
        ...
        <?php endif; ?>              
        <li class="menuItem">           
            <a href="<?php echo e(route('material.index')); ?>" class="menuOption">
                <i class="fa fa-border-all"></i><h5 class="menuText">Gest. Material</h5>
            </a> 
        </li>
        <li class="menuItem">            
            <a href="<?php echo e(route('herramienta.index')); ?>" class="menuOption">
                <i class="fas fa-tools"></i><h5 class="menuText">Gest. Herramienta</h5>
            </a> 
        </li>
        <li class="menuItem">           
            <a href="<?php echo e(route('ingreso.index')); ?>" class="menuOption">
        ...
        <li class="menuItem">          
            <a href="<?php echo e(route('proyecto.index')); ?>" class="menuOption">
                <i class="fas fa-hard-hat"></i><h5 class="menuText">Gest. Proyecto</h5>
            </a>
        </li>
        <li class="menuItem">
            <a href="<?php echo e(route('dotacion.index')); ?>" class="menuOption">
                <i class="fa fa-tag"></i><h5 class="menuText">Adm. Dotacion</h5>
            </a>           
        </li>
        <li class="menuItem">           
            <a href="<?php echo e(route('produccion.index')); ?>" class="menuOption">
                <i class="fas fa-book"></i><h5 class="menuText">Reg. Produccion</h5>
            </a> 
        </li>
        <li class="menuItem">
            <a href="<?php echo e(route('prestamo.index')); ?>" class="menuOption">
        ...
        <li class="menuItem">
            <a href="<?php echo e(route('logout')); ?>" class="menuOption">
...
</html><?php /**PATH C:\datos\proylaravel\constructora\resources\views/layouts/premium.blade.php ENDPATH**/ ?>