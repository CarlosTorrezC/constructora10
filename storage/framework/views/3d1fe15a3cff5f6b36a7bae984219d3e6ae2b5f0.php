...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
      ...
      .sidebar ul a ol li a{
       ...
       section{
        ...
        .divinfantil{            
            ...
            background-image: url("<?php echo e(asset('img/dibujo.jpg')); ?>");
            background-repeat: no-repeat;
            background-size: cover;      
        ...
        .divjuvenil{            
            width:100;
            color:white;
            background-image: url("<?php echo e(asset('img/juvenil2.jpg')); ?>");
            background-repeat: no-repeat;
            background-size: cover;      
    ...
    <div id="sidebar" class="sidebar divadulto">
        ...
        <ul>
            <li> <a href="<?php echo e(route('inicio.index')); ?>" > <i></i> Inicio</a></li>            
            <?php if(session()->get('sessionLoggedRol')=='2'): ?>
            <li> 
                <a href="#" > <i></i> Administracion</a>
                <ol>                                
                     <li class="suave"> <a href="<?php echo e(route('usuario.index')); ?>" > Gest. Usuario</a></li>                
                     <li class="suave"> <a href="<?php echo e(route('reporte.index')); ?>" > Gest. Estadisticas</a></li>                     
                </ol> 
            </li>
            <?php endif; ?>
            <li> 
                ...
                <ol> 
                     <li class="suave"> <a href="<?php echo e(route('material.index')); ?>" > Gest. Material</a></li>
                     <li class="suave"> <a href="<?php echo e(route('herramienta.index')); ?>" > Gest. Herramienta</a></li>
                     <li class="suave"> <a href="<?php echo e(route('ingreso.index')); ?>" > Reg. Ingreso</a></li>
                </ol> 
            </li>
            <li> 
                <a href="#" > <i></i> Proyecto</a>
                <ol> 
                     <li class="suave"> <a href="<?php echo e(route('proyecto.index')); ?>" > Gest. Proyecto</a></li>
                     <li class="suave"> <a href="<?php echo e(route('dotacion.index')); ?>" > Adm. Dotacion</a></li>
                     <li class="suave"> <a href="<?php echo e(route('produccion.index')); ?>" >  Reg. Produccion</a></li>
                     <li class="suave"> <a href="<?php echo e(route('prestamo.index')); ?>" >  Gest. Prestamo</a></li>
                </ol> 
            </li>
            <li> <a href="<?php echo e(route('configuracion.index')); ?>" > <i></i> Configuracion</a></li>
            <li> <a href="<?php echo e(route('logout')); ?>" > <i class="fa fa-sign-out"></i> Salir</a></li>               
        </ul>
    </div>
    <section> 
        ...
        <?php if(isset($contador)): ?>
            <div class="col-lg-12">
                <div class="d-flex justify-content-center align-items-center">
                    <br>
                        <span class="ojo fa fa-eye" style="color:white"> <?php echo e($contador); ?> </span>                                                                                                                    
                </div>
             </div>
        <?php endif; ?>      
    </section>
...
</html><?php /**PATH C:\datos\proylaravel\constructora\resources\views/layouts/normal.blade.php ENDPATH**/ ?>