            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="colorfondo ibox-content">
                        ...
                        <br>  
                        <form method="POST" action="<?php echo e(route('prestamo.store')); ?>" role="form" autocomplete="off">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.normal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\datos\proylaravel\constructora\resources\views/prestamo/create.blade.php ENDPATH**/ ?>