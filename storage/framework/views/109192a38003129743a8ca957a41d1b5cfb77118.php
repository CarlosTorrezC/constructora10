            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="colorfondo ibox-content">
                        ...
                        <br>
                        <?php echo $__env->make('dotacion.modalcreate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php if(!empty($dotacion)): ?>
                                ...
                                <tbody>                                    
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" width="100px">
                                            <form action="<?php echo e(route('dotacion.destroy', $item->id)); ?>" method="POST">                           
                                    ...
                                    <?php echo $__env->make('dotacion.modaledit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>                                            
...
<?php echo $__env->make('layouts.normal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\datos\proylaravel\constructora\resources\views/dotacion/index.blade.php ENDPATH**/ ?>