                    ...
                    <div class="colorfondo ibox-content">
                        ...
                        <div class="row">
                            <div class="col-sm-4 text-center">
                                <img id="temainfantil" width="100" height="100" src="{{ asset('img/tema1.jpg')}}">

                                </img>
                            </div>
                            <div class="col-sm-4 text-center">
                                <img id="temajuvenil" width="100" height="100" src="{{ asset('img/tema2.jpg')}}">

                                </img>
                            </div>
                            <div class="col-sm-4 text-center">
                                <img id="temaadulto" width="100" height="100" src="{{ asset('img/tema3.jpg')}}">
    ...
    function themeMode2(){
        if(localStorage.getItem("theme") !== null)
        {
            ...
            if(localStorage.getItem("theme") === "light")
            {
                ...
                source="{!! asset('img/temanoche.jpg')!!}" ;                     
            }else{
                document.body.classList.add("dark");
                source="{!! asset('img/temadia.jpg')!!}" ;
            }
